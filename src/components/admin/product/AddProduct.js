                            ...
                            <div className="tab-pane card-body border fade" id="otherdetails" role="tabpanel" aria-labelledby="otherdetails-tab">
                                <div className="row">
                                    ...
                                    <div className="col-md-4 form-group mb-3">
                                        ...
                                        <div></div>
                                        <input type="checkbox" name="featured" onChange={handleInput} checked={productInput.featured} className="w-50 h-50" />
                                    </div>
                                    <div className="col-md-4 form-group mb-3">
                                        <label>Popular (checked=shown)</label>
                                        <div></div>
                                        <input type="checkbox" name="popular" onChange={handleInput} checked={productInput.popular} className="w-50 h-50" />
                                    </div>
                                    <div className="col-md-4 form-group mb-3">
                                        <label>Status (checked=Hidden)</label>
                                        <div></div>
                                        <input type="checkbox" name="status" onChange={handleInput} checked={productInput.status} className="w-50 h-50" />
                                    </div>
                                </div>
                            </div>
                        </div>
