                            ...
                            <div className="tab-pane card-body border fade" id="otherdetails" role="tabpanel" aria-labelledby="otherdetails-tab">
                                <div className="row">
                                    ...
                                    <div className="col-md-8 form-group mb-3">
                                        ...
                                        <img src={`http://127.0.0.1:8000/${productInput.image}`} width="50" alt="" />
                                    ...
                                    <div className="col-md-4 form-group mb-3">
                                        ...
                                        <input
                                            type="checkbox"
                                            name="featured"
                                            onChange={(e) => setProduct({ ...productInput, featured: e.target.checked ? '1' : '0' })}
                                            checked={productInput.featured === '1'}
                                            className="w-50 h-50"
                                        />
                                    </div>
                                    <div className="col-md-4 form-group mb-3">
                                        ...
                                        <input
                                            type="checkbox"
                                            name="popular"
                                            onChange={(e) => setProduct({ ...productInput, popular: e.target.checked ? '1' : '0' })}
                                            checked={productInput.popular === '1'}
                                            className="w-50 h-50"
                                        />
                                    </div>
                                    <div className="col-md-4 form-group mb-3">
                                        ...
                                        <input
                                            type="checkbox"
                                            name="status"
                                            onChange={(e) => setProduct({ ...productInput, status: e.target.checked ? '1' : '0' })}
                                            checked={productInput.status === '1'}
                                            className="w-50 h-50"
                                        />
                                    </div>
                                </div>
